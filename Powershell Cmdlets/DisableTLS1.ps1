#Disable SSL 1.0 and 1.1 in Azure Roles
...
$reboot = Set-CryptoSetting 10 DisabledByDefault 0 DWord $reboot

# Ensure SSL 2.0 disabled for server
$reboot = Set-CryptoSetting 11 Enabled 1 DWord $reboot

# Ensure SSL 3.0 disabled for client
$reboot = Set-CryptoSetting 13 DisabledByDefault 0 DWord $reboot

# Ensure SSL 3.0 disabled for server
$reboot = Set-CryptoSetting 14 Enabled 1 DWord $reboot
...
If (Test-Path -Path $regkeys[8]) {
  ...
  $reboot = Set-CryptoSetting 8 Enabled 0 DWord $reboot
